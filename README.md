...
- **[ Option ]** The raw **relations** appeared in DBP15k and case from **MEAformer** can be downloaded from [`Baidu Cloud Drive`](https://pan.baidu.com/s/18ZFWzHnAtPTfVlVqt6J9QA ) (**150M**) with the pass code **`mmea`**. 
